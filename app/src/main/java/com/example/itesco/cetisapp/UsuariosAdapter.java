...
public class UsuariosAdapter   extends RecyclerView.Adapter<UsuariosAdapter.UsuariosHolder>{
    ...
    List<convenio> listaUsuarios;

    public UsuariosAdapter(List<convenio> listaUsuarios) {
    ...
    public void onBindViewHolder(UsuariosHolder holder, int position) {
        holder.txtDocumento.setText(listaUsuarios.get(position).getNombre().toString());
        holder.txtNombre.setText(listaUsuarios.get(position).getDescripcion().toString());
        holder.txtProfesion.setText(listaUsuarios.get(position).getTelefono().toString());
    }
